    ...
    stages {
        stage('SCM Checkout') {
            steps {
                ...
                git 'https://github.com/Abhishekrc7552/BankingApp.git'
       ...
       stage("Docker build"){
            steps {
				sh 'docker version'
				sh "docker build -t abhishekrc7552/bankapp-eta-app:${BUILD_NUMBER} ."
				sh 'docker image list'
				sh "docker tag abhishekrc7552/bankapp-eta-app:${BUILD_NUMBER} abhishekrc7552/bankapp-eta-app:latest"
            }
        }
		...
		stage('Push2DockerHub') {
			...
			steps {
				sh "docker push abhishekrc7552/bankapp-eta-app:latest"
			}
		}
